...
(function (globalObj) {
    ...
    function constructorFactory(configObj) {
        ...
        function convertBase(str, baseOut, baseIn, sign) {
            ...
            r = rm < 4 ? (i != null || r) && (rm == 0 || rm == (x.s < 0 ? 3 : 2)) : i > k || i == k && (rm == 4 || r || rm == 6 && xc[d - 1] & 1 ||
                rm == (x.s < 0 ? 8 : 7));
        ...
        P.toFormat = function (dp, rm) {
            ...
            if (this.c) {
                ...
                str = fractionPart ? intPart + FORMAT.decimalSeparator + ((g2 = +FORMAT.fractionGroupSize) ? fractionPart.replace(new RegExp('\\d{' + g2 + '}\\B', 'g')
                    , '$&' + FORMAT.fractionGroupSeparator) : fractionPart) : intPart;
            }
