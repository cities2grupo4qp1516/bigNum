...
rsa = {
	...
	//	g = ((alpha.mul(n)).add(1)).mul(beta.powm(n,n.pow(2)));
...
rsa.publicKey.prototype = {
	encrypt: function(m) {
		//	(this.g.pow(m)).mul(this.r.powm(this.n,this.n.pow(2)));
...
rsa.privateKey.prototype = {
		decrypt: function(c) {
		//((c.powm(this.lambda,this.n.pow(2)).sub(1)).div(this.n)).mul(this.mu).mod(this.n)
