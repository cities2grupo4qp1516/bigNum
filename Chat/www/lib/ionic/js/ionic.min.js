 ...
 ! function () {
     ...
     function h(e) {
         q = null;
         var t = !1;
         "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, X && (q = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {
             target: e
         }, !0))
     }
     ...
     function N() {
         clearTimeout(ne), ionic.keyboard.isOpen = !1, ionic.keyboard.isClosing = !1, Q && ionic.trigger("resetScrollView", {
             target: Q
     ...
     function A() {
         se = !1, ie = k(), ionic.keyboard.isLandscape && !re ? re = ie : ionic.keyboard.isLandscape || oe || (oe = ie), Q && ionic.trigger("resetScrollView", {
             target: Q
         }, !0), ionic.keyboard.isOpen && ionic.tap.isTextInput(Q) && I()
     }
     ...
     window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.1.1"
         , function (e) {
             ...
             e.CustomEvent = function () {
                 ...
                 , on: function (t, n, i) {
                     for (var o = i || window, r = 0, s = this.VIRTUALIZED_EVENTS.length; s > r; r++)
                         if (t == this.VIRTUALIZED_EVENTS[r]) {
     ...
     , function (e) {
         ...
         u.prototype = new l, u.prototype._moveElement = function (t) {
             ...
             for (var e, t = this, n = Array.prototype.slice.call(t._currentDrag.placeholder.parentNode.children).filter(function (e) {
                 ...
                 }), i = t._currentDrag.currentY, o = 0, r = n.length; r > o; o++)
                 if (e = n[o], o === r - 1) {
